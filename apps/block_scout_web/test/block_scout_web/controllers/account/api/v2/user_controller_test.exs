defmodule BlockScoutWeb.Account.Api.V2.UserControllerTest do
  ...
  describe "Test account/api/account/v2/user" do
    ...
    test "post && get watchlist address", %{conn: conn} do
      ...
      get_watchlist_address_response = conn |> get("/api/account/v2/user/watchlist") |> json_response(200) |> Enum.at(0)
      ...
      get_watchlist_address_response_1_1 =
        conn |> get("/api/account/v2/user/watchlist") |> json_response(200) |> Enum.at(0)
    ...
    test "delete watchlist address", %{conn: conn} do
      ...
      get_watchlist_address_response_1_0 =
        conn |> get("/api/account/v2/user/watchlist") |> json_response(200) |> Enum.at(1)
      ...
      assert conn |> get("/api/account/v2/user/watchlist") |> json_response(200) == []
    end
    ...
    test "watchlist address returns with token balances info", %{conn: conn} do
      ...
      [wa2, wa1] = conn |> get("/api/account/v2/user/watchlist") |> json_response(200)
    ...
    test "watchlist address returns with token balances info + handle nil fiat values", %{conn: conn} do
      ...
      [wa1] = conn |> get("/api/account/v2/user/watchlist") |> json_response(200)
